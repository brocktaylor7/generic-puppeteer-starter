                ...
                case 0: return [4 /*yield*/, puppeteer_1.default.launch({ headless: false, defaultViewport: null }).then(function (browser) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    page = _a.sent();
                                    page.on('console', function (message) { return console.log("".concat(message.type().substr(0, 3).toUpperCase(), " ").concat(message.text())); });
                                    return [4 /*yield*/, page.goto('https://microsoft.com')];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
